...
public readonly record struct EntityEffectEvent<T>(T Effect, float Scale, EntityUid? User, bool Predicted) where T : EntityEffectBase<T> // Oathlord
{
    /// <summary>
    ...
    /// <summary>
    /// Oathlord - Whether this effect should be predicted.
    /// </summary>
